...
import ro.autogest.client.service.UserService;
...
//        setSupportActionBar(toolbar);
        ...
        UserService.getInstance().getUserInfo(this);
    }

    @Override
    public void handleServiceResponse(Object utilizator) {
        welcomeText.setText("Bine ai venit " + ((Utilizator)utilizator).getNume() + "!");
    }
